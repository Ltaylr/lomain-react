    ...
    return(
        ...
        <div className="flex flex-wrap gap-4 pt-10">
              ...
              dark:bg-bgray-800 dark:border-gray-700 dark:hover:bg-gray-900">
                <a href={"/campaign/" + camp?._id} className="block  aspect-square p-1 md:p-3 rounded-lg shadow-sm dark:bg-gray-800/30 dark:border-gray-700">
                    <img className="rounded-lg mb-5 pt-3 pb-3 w-[85%] mx-auto" src={baseUrl + '/images/' + camp?.imageUrl}alt=""/>
            ...
            <div className="
              ...
              dark:bg-bgray-800 dark:border-gray-700 dark:hover:bg-gray-900" >
                    <div className="bg-gray-800 rounded-lg p-2 md:p-4 border border-gray-500">
                        <a className="max-w-full rounded-lg object-cover object-center" href="/campaign/gallery/<%= campaign._id %>">
